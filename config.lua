...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -211.6579, y = -1324.2728, z = 30.1582},
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {5.00, 6.00, 7.00, 8.00}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {0.50, 1.0, 1.50, 2.00}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {0.50, 1.50, 2.00, 2.50, 3.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	wheels = {
		...
		modBackWheelsTypes = _U('wheel_type2'),
	...
	modFrontWheelsTypes = {
		...
		modFrontWheelsType6	= _U('highend'),
		modFrontWheelsType7	= _U('original'),
		modFrontWheelsType8	= _U('bespoke'),
		modFrontWheelsType9	= _U('open'),
		modFrontWheelsType10 = _U('street'),
		modFrontWheelsType11 = _U('track'),
	},
	modBackWheelsTypes = {
		label				= _U('wheel_type'),
		parent				= 'wheels',
		modBackWheelsType1	= _U('motorcycle'),
		modBackWheelsType2	= _U('motorcycle2'),
	},
	modFrontWheelsType0 = {
		label = _U('sport'),
